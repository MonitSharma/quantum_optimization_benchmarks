...
for file_path in file_paths:
    ...
    max_no_improvement_rounds = 2  # Stop after 10 consecutive rounds without improvement
    ...
    while no_improvement_count < max_no_improvement_rounds:
        ...
        logger.info(f"QAP cost: {market_share_cost}")
    ...
    initial_feasible = qp.get_feasibility_info(market_share_bitstring)[0]
    market_share_cost = qp.objective.evaluate(market_share_bitstring)
    print(f"QAP cost: {market_share_cost} and Feasibility: {initial_feasible}")
